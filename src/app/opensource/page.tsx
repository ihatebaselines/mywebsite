    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHero}>
        ...
        <div className={styles.sectionHeader} data-reveal>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
            <p style={{ margin: 0 }}>Open Source</p>
            {/* Easter Egg: Closed Source Detected */}
            <span
              ...
              style={{
                ...
                fontSize: "11px",
                color: closedHover ? "#10b981" : "var(--text-dim)",
              ...
              title="Audit scanner"
            >
              {closedHover ? "good." : "closed source detected: 0"}
            </span>
          </div>
      ...
      <section className={styles.band}>
        <div className={styles.osGrid}>
          {items.map((item) => {
            const isSocrateX = item.slug.toLowerCase().includes("socratex") || item.name.toLowerCase().includes("socratex");
